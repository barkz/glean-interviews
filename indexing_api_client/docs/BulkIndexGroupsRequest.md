...
------------ | ------------- | ------------- | -------------
**upload\_id** | **str** | Unique id that must be used for this instance of datasource groups upload | 
**datasource** | **str** | datasource of the groups | 
...
**disable\_stale\_data\_deletion\_check** | **bool** | True if older group data needs to be force deleted after the upload completes. Defaults to older data being deleted only if the percentage of data being deleted is less than a reasonable threshold. This must only be set when &#x60;isLastPage &#x3D; true&#x60; | [optional] 
