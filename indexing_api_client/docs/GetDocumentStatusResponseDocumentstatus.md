# GetDocumentStatusResponseDocumentstatus


## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**datasource** | **str** | Document datasource | [optional] 
**object\_type** | **str** | Document object type | [optional] 
**doc\_id** | **str** | Document ID | [optional] 
