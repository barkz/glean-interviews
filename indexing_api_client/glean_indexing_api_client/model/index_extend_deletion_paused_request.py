...
class IndexExtendDeletionPausedRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, days, *args, **kwargs):  # noqa: E501
        """IndexExtendDeletionPausedRequest - a model defined in OpenAPI

        Args:
            days (int): Number of days to extend the deletion paused event by
