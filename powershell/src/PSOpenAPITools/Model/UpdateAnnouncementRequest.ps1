...
UpdateAnnouncementRequest<PSCustomObject>
#>

function Initialize-UpdateAnnouncementRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UpdateAnnouncementRequest' | Write-Debug
...
Convert from JSON to UpdateAnnouncementRequest<PSCustomObject>
...
UpdateAnnouncementRequest<PSCustomObject>
#>
function ConvertFrom-JsonToUpdateAnnouncementRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UpdateAnnouncementRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateAnnouncementRequest
        ...
        If ([string]::IsNullOrEmpty($Json) -or $Json -eq "{}") { # empty json
            throw "Error! Empty JSON cannot be serialized due to the required property 'startTime' missing."
        }
