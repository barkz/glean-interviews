...
AnnouncementMutableProperties<PSCustomObject>
#>

function Initialize-AnnouncementMutableProperties {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AnnouncementMutableProperties' | Write-Debug
...
Convert from JSON to AnnouncementMutableProperties<PSCustomObject>
...
AnnouncementMutableProperties<PSCustomObject>
#>
function ConvertFrom-JsonToAnnouncementMutableProperties {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AnnouncementMutableProperties' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AnnouncementMutableProperties
