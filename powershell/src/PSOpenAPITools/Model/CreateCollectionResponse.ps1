...
CreateCollectionResponse<PSCustomObject>
#>

function Initialize-CreateCollectionResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateCollectionResponse' | Write-Debug
...
Convert from JSON to CreateCollectionResponse<PSCustomObject>
...
CreateCollectionResponse<PSCustomObject>
#>
function ConvertFrom-JsonToCreateCollectionResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateCollectionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateCollectionResponse
