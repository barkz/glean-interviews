...
function Initialize-Chat {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Chat' | Write-Debug
...
Convert from JSON to Chat<PSCustomObject>
...
Chat<PSCustomObject>
#>
function ConvertFrom-JsonToChat {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Chat' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Chat
        $AllProperties = ("messages", "id", "createTime", "createdBy", "updateTime", "name", "applicationId")
