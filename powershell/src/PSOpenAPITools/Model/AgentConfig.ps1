...
function Initialize-AgentConfig {
    ...
    Param (
        ...
        [ValidateSet("DEFAULT", "GPT")]
        [String]
        ${Agent},
        [Parameter(Position = 1, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("DEFAULT", "QUICK")]
        [String]
        ${Mode}
    )

    Process {
        'Creating PSCustomObject: PSOpenAPITools => AgentConfig' | Write-Debug
...
Convert from JSON to AgentConfig<PSCustomObject>
...
AgentConfig<PSCustomObject>
#>
function ConvertFrom-JsonToAgentConfig {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AgentConfig' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AgentConfig
        $AllProperties = ("agent", "mode")
