...
function ConvertFrom-JsonToUser {
    ...
    Process {
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "origID"))) { #optional property not found
            $OrigID = $null
        } else {
            $OrigID = $JsonParameters.PSobject.Properties["origID"].value
        }
