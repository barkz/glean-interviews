...
EditPermissionsRequest<PSCustomObject>
#>

function Initialize-EditPermissionsRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EditPermissionsRequest' | Write-Debug
...
Convert from JSON to EditPermissionsRequest<PSCustomObject>
...
EditPermissionsRequest<PSCustomObject>
#>
function ConvertFrom-JsonToEditPermissionsRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EditPermissionsRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EditPermissionsRequest
        $AllProperties = ("userIds", "permissions")
