...
CountInfo<PSCustomObject>
#>

function Initialize-CountInfo {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CountInfo' | Write-Debug
...
Convert from JSON to CountInfo<PSCustomObject>
...
CountInfo<PSCustomObject>
#>
function ConvertFrom-JsonToCountInfo {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CountInfo' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CountInfo
        $AllProperties = ("count", "period", "org")
