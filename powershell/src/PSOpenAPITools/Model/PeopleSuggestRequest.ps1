...
PeopleSuggestRequest<PSCustomObject>
#>

function Initialize-PeopleSuggestRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PeopleSuggestRequest' | Write-Debug
...
Convert from JSON to PeopleSuggestRequest<PSCustomObject>
...
PeopleSuggestRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPeopleSuggestRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PeopleSuggestRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PeopleSuggestRequest
        $AllProperties = ("categories", "departments")
