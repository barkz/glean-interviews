...
CreateAnnouncementRequest<PSCustomObject>
#>

function Initialize-CreateAnnouncementRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CreateAnnouncementRequest' | Write-Debug
...
Convert from JSON to CreateAnnouncementRequest<PSCustomObject>
...
CreateAnnouncementRequest<PSCustomObject>
#>
function ConvertFrom-JsonToCreateAnnouncementRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CreateAnnouncementRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CreateAnnouncementRequest
        $AllProperties = ("startTime", "endTime", "title", "body", "emoji", "thumbnail", "banner", "audienceFilters", "sourceDocumentId", "hideAttribution", "channel", "postType", "isPrioritized", "viewUrl")
