...
UpdateDraftAnnouncementRequest<PSCustomObject>
#>

function Initialize-UpdateDraftAnnouncementRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UpdateDraftAnnouncementRequest' | Write-Debug
...
Convert from JSON to UpdateDraftAnnouncementRequest<PSCustomObject>
...
UpdateDraftAnnouncementRequest<PSCustomObject>
#>
function ConvertFrom-JsonToUpdateDraftAnnouncementRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UpdateDraftAnnouncementRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UpdateDraftAnnouncementRequest
        $AllProperties = ("startTime", "endTime", "title", "body", "emoji", "thumbnail", "banner", "audienceFilters", "sourceDocumentId", "hideAttribution", "channel", "postType", "isPrioritized", "viewUrl", "id", "draftId")
