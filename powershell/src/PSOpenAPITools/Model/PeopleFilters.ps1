...
PeopleFilters<PSCustomObject>
#>

function Initialize-PeopleFilters {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PeopleFilters' | Write-Debug
...
Convert from JSON to PeopleFilters<PSCustomObject>
...
PeopleFilters<PSCustomObject>
#>
function ConvertFrom-JsonToPeopleFilters {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PeopleFilters' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PeopleFilters
        $AllProperties = ("filter", "query")
