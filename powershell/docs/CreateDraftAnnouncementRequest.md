...
**Id** | **Int32** | The opaque id of the parent announcement. | [optional] 

## Examples

- Prepare the resource
```powershell
$CreateDraftAnnouncementRequest = Initialize-PSOpenAPIToolsCreateDraftAnnouncementRequest  -StartTime null `
 -EndTime null `
 -Title null `
 -Body null `
 -Emoji null `
...
```powershell
$CreateDraftAnnouncementRequest | ConvertTo-JSON
```
