...
------------ | ------------- | ------------- | -------------
**StartTime** | **System.DateTime** | The date and time at which the announcement becomes active. | 
**EndTime** | **System.DateTime** | The date and time at which the announcement expires. | 
...
```powershell
$CreateAnnouncementRequest = Initialize-PSOpenAPIToolsCreateAnnouncementRequest  -StartTime null `
 -EndTime null `
 -Title null `
 -Body null `
 -Emoji null `
...
```powershell
$CreateAnnouncementRequest | ConvertTo-JSON
```
